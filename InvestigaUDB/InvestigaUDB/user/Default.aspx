<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="InvestigaUDB.user.Default" %>
	    ...
	    <div class="row">
            <nav class='navbar navbar-default navbar-fixed-top navigation' style="background-color:#367fa9; border-bottom-color:#367fa9;">
	            ...
	            <ul class='nav navbar-nav navbar-right'>
                    <li><a href='#'  style="color:white;" id="loginbtn">USUARIO DEMO <i class="fa fa-angle-double-down"></i></a></li>
                </ul>
                </div>
                </div>
            </nav><br /><br />
